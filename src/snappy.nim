...
proc snappy_compress(
    input: cstring;
    input_length: csize;
    compressed:  cstring;
    compressed_length: ptr csize
  ): snappy_status
  {.cdecl, importc: "snappy_compress", dynlib: libsnappy.}
...
proc snappy_max_compressed_length(
    source_length: csize
  ): csize
  {.cdecl, importc: "snappy_max_compressed_length", dynlib: libsnappy.}
...
proc snappy_uncompressed_length(
  ...
  {.cdecl, importc: "snappy_uncompressed_length", dynlib: libsnappy.}
  ##REQUIRES: "compressed[]" was produced by snappy_compress()
  ##Returns SNAPPY_OK and stores the length of the uncompressed data in
  ##*result normally. Returns SNAPPY_INVALID_INPUT on parsing error.
  ##This operation takes O(1) time.

proc snappy_validate_compressed_buffer(
    compressed: cstring;
    compressed_length: csize
  ): snappy_status
...
proc compress*(input: seq[uint8]): seq[uint8] =
  ...
  cast[seq[uint8]](compress(cast[string](input)))
...
proc uncompress*(input: seq[uint8]): seq[uint8] =
  ## Uncompress a byte array.
  cast[seq[uint8]](uncompress(cast[string](input)))